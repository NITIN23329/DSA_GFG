...
public class DivideArraysInSetsOfKConsecutiveNumbers {
 ...
 /*
     approach :
       ...
       --> But when we will know we have to move? When curr is not present in nums[]. We can use TreeSet<> to find next greater  element in nums[].
